...
`npx create-react-app my-app --template animated-routes`

## Available Scripts

Same scripts and base features as in a plain [Create React App](https://github.com/facebook/create-react-app) are available.
